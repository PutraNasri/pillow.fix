...
public class list_kutaraja extends Activity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_kutaraja);
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(list_kutaraja.this,"Mengambil Data","Loading...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(config.URL_GET_ALL_KUTARAJA);
                return s;
            }
        }
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                list_kutaraja.this, list, R.layout.list_filter,
