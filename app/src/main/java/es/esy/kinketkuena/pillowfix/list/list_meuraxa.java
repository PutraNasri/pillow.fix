...
import es.esy.kinketkuena.pillowfix.detail.detail_meuraxa;


@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class list_meuraxa extends Activity implements ListView.OnItemClickListener{
    private ListView listView;
    private String JSON_STRING;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_meuraxa);
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(list_meuraxa.this,"Mengambil Data","Loading...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(config.URL_GET_ALL_MEURAXA);
                return s;
            }
        }
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                list_meuraxa.this, list, R.layout.list_filter,
