...
public class detail_kutaraja extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_kutaraja);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(detail_kutaraja.this,"Menampilkan Data...","Loading...",false,false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(config.URL_GET_KUTARAJA, id);
                return s;
            }
        }
