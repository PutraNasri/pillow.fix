...
public class detail_ulekareng extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_ulekareng);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(detail_ulekareng.this,"Menampilkan Data...","Loading...",false,false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(config.URL_GET_ULEKARENG, id);
                return s;
            }
        }
