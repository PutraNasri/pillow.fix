...
public class detail_luengbata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_luengbata);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(detail_luengbata.this,"Menampilkan Data...","Loading...",false,false);
            }
            @Override
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam(config.URL_GET_LUENGBATA, id);
                return s;
            }
        }
    ...
    public void sms (View view){
        ...
        try {
            ...
            Toast.makeText(detail_luengbata.this,
